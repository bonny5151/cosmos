...
v2 = await osmclient.sendIbcTokens(w1.address, w.address, a.coin(1,atom1),"transfer", "channel-0", "", Math.floor(Date.now() / >
c1 = 'cro1cu3pfakqz7mu5fy0rjr9a8ck8uxpcgl7yt9yjg'
cro = "ibc/E6931F78057F7CC5DA0FD6CEF82FF39373A6E0452BF1FD76910B93292CF356C1"
v2 = await osmclient2.sendIbcTokens(w1.address, c1, a.coin(1,cro),"transfer", "channel-5", "", Math.floor(Date.now() / 1000) + >
c1
